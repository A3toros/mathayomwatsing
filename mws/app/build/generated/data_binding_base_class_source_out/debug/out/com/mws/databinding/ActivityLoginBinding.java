...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull LinearLayout rootView, @NonNull MaterialButton btnLogin,
      @NonNull TextInputEditText etPassword, @NonNull TextInputEditText etStudentId,
      @NonNull FrameLayout loadingView, @NonNull TextView tvError) {
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((LinearLayout) rootView, btnLogin, etPassword, etStudentId,
          loadingView, tvError);
    }
