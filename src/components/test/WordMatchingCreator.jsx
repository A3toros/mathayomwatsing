    ...
    >
      ...
      <Card className="mb-6">
        <div className="word-pairs-section">
          ...
          <div className="pairs-list space-y-3">
            {wordPairs.map((pair, index) => (
              <div key={index} className="word-pair-row flex items-center space-x-4 p-4 bg-gray-50 rounded-lg border">
                <div className="pair-number flex-shrink-0">
                  <span className="number-badge w-8 h-8 bg-blue-500 text-white rounded-full flex items-center justify-center text-sm font-semibold">
                    {index + 1}
                  </span>
                </div>
                ...
                <div className="pair-arrow flex-shrink-0 text-gray-500 text-xl">
                  →
                </div>
                ...
                <div className="pair-actions flex-shrink-0">
                  <Button 
                    ...
                    variant="outline" 
                    size="sm"
                    className="remove-btn w-8 h-8 p-0 text-red-500 hover:bg-red-50"
