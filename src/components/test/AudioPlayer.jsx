      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="mb-4">
            <div
              ref={progressRef}
              className="w-full bg-gray-200 rounded-full h-3 cursor-pointer hover:h-4 transition-all min-h-[24px]"
              onClick={handleSeek}
            >
              <div
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className="bg-blue-600 text-white p-3 rounded-full hover:bg-blue-700 transition-colors min-h-[44px] min-w-[44px] flex items-center justify-center"
              >
                {isPlaying ? (
              ...
              <div className="flex items-center space-x-2">
                ...
                <input
                  ...
                  className="w-24 h-3 bg-gray-200 rounded-lg appearance-none cursor-pointer min-h-[20px]"
                />
                <span className="text-sm text-gray-600 w-10 font-medium">{Math.round(volume * 100)}%</span>
              </div>
            </div>
