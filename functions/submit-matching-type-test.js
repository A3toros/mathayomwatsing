...
exports.handler = async function(event, context) {
  ...
  try {
    ...
    if (!student_id || !test_id || !student_answers || score === undefined || !max_score) {
    ...
    try {
      ...
      // Insert into matching_type_test_results table
      console.log('Inserting into matching_type_test_results table...');
      ...
      console.log('Matching type test result saved with ID:', resultId);
      ...
      return {
        ...
        body: JSON.stringify({
          success: true,
          message: 'Matching type test results saved successfully',
          result_id: resultId
        })
      };
    ...
    console.error('Error saving matching type test results:', error);
